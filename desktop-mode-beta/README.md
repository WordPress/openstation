...
Grab `desktop-mode-beta.zip` from any [release](https://github.com/WordPress/openstation/releases) (attached alongside `openstation.zip`), or build it from a checkout:
