...
#
# The phpMyAdmin shortcut (includes/phpmyadmin/) is a no-op until this
# script populates the vendor directory — it's gitignored because the
# extracted distribution is ~50MB and changes on phpMyAdmin's release
# cadence, not ours. Run before bin/package.sh to bundle phpMyAdmin in
# the release zip.
#
