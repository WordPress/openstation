 ...
 * filled disc with the W knocked out by the nonzero fill rule — scaled
 * 1.15× from its 20-unit box and centred on the folder's front panel
 * with a whole stroke-width of clearance on every side.
 *
...
function openstation_my_wordpress_icon_svg() {
	return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">'
		...
		// The WordPress mark, centred on the front panel at r=11.5.
		. '<g transform="translate(20.5 24) scale(1.15)">'
