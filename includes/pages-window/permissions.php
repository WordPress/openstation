 ...
 * @return bool
 */
function open_station_pages_window_user_can_register( $user_id = null ) {
 ...
 * {@see open_station_pages_window_user_can_register()}; the JS-side
 ...
 * @return bool
 */
function open_station_pages_window_user_can_use( $user_id = null ) {
	$user_id = null === $user_id ? get_current_user_id() : (int) $user_id;

	$cap_ok = open_station_pages_window_user_can_register( $user_id );
	 ...
	 * @param int  $user_id User being checked.
	 */
	return (bool) apply_filters( 'open_station_pages_window_user_can_use', $can, $user_id );
}
