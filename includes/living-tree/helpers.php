 ...
 */
function open_station_living_tree_install_epoch() {
	global $wpdb;
 ...
 */
function open_station_living_tree_site_age_days() {
	$epoch = open_station_living_tree_install_epoch();
	if ( $epoch <= 0 ) {
		return 0;
	}
 ...
 *
 * The final value passes through the `open_station_living_tree_traffic`
 * filter so analytics plugins with their own counters can feed the
 * real number in.
 *
 * @return int Recent view sum. >= 0.
 */
function open_station_living_tree_traffic() {
	$views = open_station_living_tree_jetpack_visits();
	if ( null === $views ) {
		$views = open_station_living_tree_meta_views();
	}
	 ...
	 *                   sum, else 0.
	 */
	$views = (int) apply_filters( 'open_station_living_tree_traffic', $views );
	return max( 0, $views );
}
 ...
 *                  Stats can't answer.
 */
function open_station_living_tree_jetpack_visits() {
 ...
 * @return int Recent view sum. >= 0.
 */
function open_station_living_tree_meta_views() {
	global $wpdb;
 ...
 */
function open_station_living_tree_active_users() {
	if ( ! function_exists( 'open_station_presence_snapshot' ) ) {
		return 0;
	}
	$count = 0;
	foreach ( open_station_presence_snapshot() as $record ) {
 ...
 */
function open_station_living_tree_seo_health() {
	/**
	 ...
	 */
	$health = (float) apply_filters( 'open_station_living_tree_seo_health', 0.7 );
 ...
 * {@see open_station_living_tree_site_health_performance()}), falling
 ...
 */
function open_station_living_tree_performance() {
	$performance = open_station_living_tree_site_health_performance();
	if ( null === $performance ) {
		$performance = 0.8;
	}
	 ...
	 */
	$performance = (float) apply_filters( 'open_station_living_tree_performance', $performance );
 ...
 */
function open_station_living_tree_site_health_performance() {
 ...
 */
function open_station_living_tree_branch_dna() {
	global $wpdb;
