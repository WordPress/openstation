 ...
 *                        through {@see open_station_users_window_assignable_roles()}.
 ...
 * @return bool
 */
function open_station_users_window_user_can_register( $user_id = null ) {
 ...
 * @return bool
 */
function open_station_users_window_user_can_use( $user_id = null ) {
	$user_id = null === $user_id ? get_current_user_id() : (int) $user_id;

	$cap_ok = open_station_users_window_user_can_register( $user_id );
	 ...
	 * @param int  $user_id User being checked.
	 */
	return (bool) apply_filters( 'open_station_users_window_user_can_use', $can, $user_id );
}
 ...
 * or `open_station_users_window_assignable_roles` below. We compute
 ...
 */
function open_station_users_window_assignable_roles( $viewer_id, $target_id = 0 ) {
