 ...
 * `desktop_mode_window_related_entities_for_post()`, the
 * `desktop_mode_window_related_entities` filter, and the `related`
 ...
 * @group desktop-mode
 */
class Tests_DesktopMode_RelatedEntities extends WP_UnitTestCase {
	...
	public function tear_down() {
		...
		remove_all_filters( 'desktop_mode_window_related_entities' );
		parent::tear_down();
	}
	...
	public function test_comments_item_carries_count_and_filtered_url() {
		...
		$related  = desktop_mode_window_related_entities_for_post( get_post( $post_id ) );
	...
	public function test_custom_post_types_get_no_builtin_items() {
		...
		$related = desktop_mode_window_related_entities_for_post( get_post( $order_id ) );
	 ...
	 *
	 * @covers ::desktop_mode_window_related_entities_sanitize
	 */
	public function test_sanitizer_drops_malformed_items_and_whitelists_fields() {
		$sanitized = desktop_mode_window_related_entities_sanitize(
			array(
				array(
					'id'    => 'good',
					'group' => 'acme/things',
