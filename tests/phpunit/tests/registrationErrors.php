 ...
 *
 * Every `wp_register_desktop_*()` function returns `true` on success
...
class Tests_DesktopMode_RegistrationErrors extends WP_UnitTestCase {
	...
	public function test_window_missing_id_returns_wp_error() {
		$result = wp_register_desktop_window( '', $this->valid_window_args() );
	...
	public function test_window_success_returns_true() {
		$result = wp_register_desktop_window( 'ok-window', $this->valid_window_args() );

		$this->assertTrue( $result );
		$this->assertNotNull( wpdm_native_window_registry( 'ok-window' ) );
	}
	...
	public function test_widget_missing_id_returns_wp_error() {
		$result = wp_register_desktop_widget( '', $this->valid_widget_args() );
	...
	public function test_widget_missing_label_returns_wp_error() {
		$result = wp_register_desktop_widget(
			'no-label',
	...
	public function test_widget_success_returns_true() {
		$result = wp_register_desktop_widget( 'ok-widget', $this->valid_widget_args() );
	...
	public function test_wallpaper_missing_id_returns_wp_error() {
		$result = wp_register_desktop_wallpaper( '', $this->valid_wallpaper_args() );
	...
	public function test_wallpaper_missing_label_returns_wp_error() {
		$result = wp_register_desktop_wallpaper(
			'no-label',
	...
	public function test_wallpaper_success_returns_true() {
		$result = wp_register_desktop_wallpaper( 'ok-wallpaper', $this->valid_wallpaper_args() );
	...
	/**
	 * Legacy callers wrote `if ( wp_register_desktop_window( ... ) )`
	...
	public function test_wp_error_return_is_truthy_for_legacy_callers() {
		$w = wp_register_desktop_window( '', $this->valid_window_args() );
		$g = wp_register_desktop_widget( '', $this->valid_widget_args() );
		$p = wp_register_desktop_wallpaper( '', $this->valid_wallpaper_args() );
