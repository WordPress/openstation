<?php
/**
 * Tests for `open_station_my_wordpress_collect_preview_actions()`.
 *
...
class Tests_OpenStation_MyWordpressPreviewActions extends WP_UnitTestCase {
	...
	public function tear_down() {
		remove_all_filters( 'open_station_my_wordpress_preview_actions' );
		parent::tear_down();
	}

	/**
	 * @covers ::open_station_my_wordpress_collect_preview_actions
	 */
	public function test_capability_gating_drops_actions_for_subscriber() {
		add_filter(
			'open_station_my_wordpress_preview_actions',
		...
		$ids = wp_list_pluck( open_station_my_wordpress_collect_preview_actions(), 'id' );
