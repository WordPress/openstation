 ...
 *
 * Covers `openstation_phpmyadmin_user_can_use()` — the authorization
 ...
 * `openstation_phpmyadmin_user_can_use` filter may adjust who can use
...
class Tests_OpenStation_PhpMyAdminUserCanUse extends WP_UnitTestCase {
	 ...
	 *
	 * @covers ::openstation_phpmyadmin_user_can_use
	 */
