 ...
 */
class Tests_DesktopMode_MyWordpressUserFootprint extends WP_UnitTestCase {
	 ...
	 *
	 * @covers ::desktop_mode_my_wordpress_user_footprint_callback
	 */
	 ...
	 *
	 * @covers ::desktop_mode_my_wordpress_register_user_footprint_route
	 */
