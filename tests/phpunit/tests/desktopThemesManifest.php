...
class Tests_OpenStation_DesktopThemesManifest extends WP_UnitTestCase {
	...
	public function test_wrong_manifest_version_is_fatal() {
		...
		$this->assertSame( 'open_station_desktop_theme_bad_version', $error->get_error_code() );
	}
	...
	public function test_missing_name_is_fatal() {
		...
		$this->assertWPError( $error );
		$this->assertSame( 'open_station_desktop_theme_missing_name', $error->get_error_code() );
	}
	...
	public function test_bad_ids_are_fatal( $id ) {
		...
		$this->assertSame( 'open_station_desktop_theme_bad_id', $error->get_error_code() );
	}
	...
	/**
	 * @covers ::open_station_sanitize_desktop_theme_tokens
	 */
	...
	public function test_unsafe_css_values_are_rejected( $value ) {
		$this->assertFalse(
			open_station_desktop_theme_is_safe_css_value( $value ),
	...
	public function test_manifest_filter_receives_raw_and_slug() {
		$seen = array();
		add_filter(
			'open_station_desktop_theme_manifest',
		...
		remove_all_filters( 'open_station_desktop_theme_manifest' );
	}

	/**
	 * @covers ::open_station_desktop_theme_icon_slots
	 */
	public function test_icon_slot_allowlist_is_filterable() {
		add_filter(
			'open_station_desktop_theme_icon_slots',
		...
		remove_all_filters( 'open_station_desktop_theme_icon_slots' );
	}
	...
	public function test_php_and_ts_slot_lists_match() {
		$ts = OPEN_STATION_DIR . 'src/desktop-themes/slots.ts';
		...
		sort( $ts_slots );
		$php_slots = open_station_desktop_theme_icon_slots();
		sort( $php_slots );

		$this->assertSame(
			$php_slots,
			$ts_slots,
			'open_station_desktop_theme_icon_slots() and DESKTOP_THEME_SLOTS have drifted.'
		);
	}
}
