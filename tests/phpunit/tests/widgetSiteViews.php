 ...
 * @group desktop-mode
 */
class Tests_DesktopMode_WidgetSiteViews extends WP_UnitTestCase {
	...
	/**
	 * @covers ::desktop_mode_site_views_meta_callback
	 */
	public function test_aggregates_todays_views_across_posts() {
		...
		$result = desktop_mode_site_views_meta_callback( null );
	...
	public function test_result_is_served_from_the_transient() {
		...
		$first = desktop_mode_site_views_meta_callback( null );
		...
		$second = desktop_mode_site_views_meta_callback( null );
		$this->assertSame( $first, $second, 'second call inside the TTL is a cache hit' );

		delete_transient( 'desktop_mode_site_views_meta' );
		$third = desktop_mode_site_views_meta_callback( null );
