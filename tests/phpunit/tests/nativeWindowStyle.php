<?php
/**
 * Tests for the optional `style` arg on `desktop_mode_register_window()`
 * and its companion resolver `desktop_mode_resolve_style_payload()`.
 *
 ...
 *
 * @group desktop-mode
 * @group desktop-mode-native-window-style
 */
class Tests_DesktopMode_NativeWindowStyle extends WP_UnitTestCase {
	...
	private function register_demo_window( $args = array() ) {
		...
		$this->assertTrue( desktop_mode_register_window( 'demo-style', $args ) );
	}

	// --------------------------------------------------------------
	// desktop_mode_resolve_style_payload
	// --------------------------------------------------------------

	/**
	 * @covers ::desktop_mode_resolve_style_payload
	 */
	public function test_resolve_style_payload_unregistered_handle_returns_empty() {
		$payload = desktop_mode_resolve_style_payload( 'never-registered' );
	...
	public function test_resolve_style_payload_returns_url_with_version() {
		...
		$payload = desktop_mode_resolve_style_payload( 'jorvy-style' );
	...
	public function test_resolve_style_payload_relative_src_is_prefixed_with_site_url() {
		...
		$payload = desktop_mode_resolve_style_payload( 'rel-style' );
