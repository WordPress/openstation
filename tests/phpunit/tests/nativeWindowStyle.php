<?php
/**
 * Tests for the optional `style` arg on `open_station_register_window()`
 * and its companion resolver `open_station_resolve_style_payload()`.
 *
...
class Tests_OpenStation_NativeWindowStyle extends WP_UnitTestCase {
	...
	private function register_demo_window( $args = array() ) {
		...
		$this->assertTrue( open_station_register_window( 'demo-style', $args ) );
	}

	// --------------------------------------------------------------
	// open_station_resolve_style_payload
	// --------------------------------------------------------------

	/**
	 * @covers ::open_station_resolve_style_payload
	 */
	public function test_resolve_style_payload_unregistered_handle_returns_empty() {
		$payload = open_station_resolve_style_payload( 'never-registered' );
	...
	public function test_resolve_style_payload_returns_url_with_version() {
		...
		$payload = open_station_resolve_style_payload( 'jorvy-style' );
	...
	public function test_resolve_style_payload_relative_src_is_prefixed_with_site_url() {
		...
		$payload = open_station_resolve_style_payload( 'rel-style' );
