...
phone overflow. The actual Comments client view and production stylesheet also run with deterministic data: the composer stays visible, and narrow list/detail navigation preserves the divider position. Unit tests cover property lifecycle and app integration.
