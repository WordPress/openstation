 ...
 *
 * `unified` leads the list because it is the default: one dock is the
 * shape a first-run desktop arrives in. The other two split navigation
 * across two surfaces, which is a deliberate choice rather than a
 * starting point.
 */
