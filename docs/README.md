...
22. **[Fleet OAuth](./fleet-oauth.md)** — *Experimental.* Authorization Code + PKCE for a Fleet hub, the `site:manage` authority model, discovery, token rotation, and revocation. Read before changing the Fleet authentication server.
