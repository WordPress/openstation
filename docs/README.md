...
11. **[Routines](./routines.md)** — *Stable (since 0.22.0).* Visual automation engine — triggers (hooks + broadcasts), step kinds, security model, REST API, and the `wp_register_desktop_routine_*` registration surface. See also [examples/register-routine-trigger.md](./examples/register-routine-trigger.md).
