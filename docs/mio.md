...
Off by default. Users switch it on from its **dock tile**, and can hide the tile itself from OpenStation Preferences → Apps & Icons.
...
| Get rid of the tile | OpenStation Preferences → **Apps & Icons** → Mio → **Hidden** |
