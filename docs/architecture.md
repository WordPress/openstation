...
3. The landing page renders with the shell wrapped around it (Station Home by default through the Dashboard URL remap; the user's saved focused window, the default-window preference, or the `target` URL otherwise).
