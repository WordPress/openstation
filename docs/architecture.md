...
│   └── Mascot layer         — optional soft-body companion, above windows,
│                              below the dock (see docs/mascot.md)
│
