...
- [App layouts: dashboard grids, scrolling settings, list/detail and editor/preview](./app-layouts.md) — Experimental extensions
...
- [Window activity & the status ring — `wp.os.fetch`, `Window.trackActivity`](./window-activity.md)
