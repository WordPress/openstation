...
define( 'OPEN_STATION_VERSION', '0.9.8' );
define( 'OPEN_STATION_FILE', __FILE__ );
define( 'OPEN_STATION_DIR', plugin_dir_path( __FILE__ ) );
define( 'OPEN_STATION_URL', plugin_dir_url( __FILE__ ) );
 ...
 * driven post saves), and expose `open_station_register_*()` APIs
 ...
 */
function open_station_request_needs_admin_modules() {
	$needs = is_admin()
		|| wp_doing_cron()
	 ...
	 */
	return (bool) apply_filters( 'open_station_load_admin_modules', $needs );
}

// Foundation primitives — must load before anything that consumes them.
require_once OPEN_STATION_DIR . 'includes/core/registry-factory.php';
...
require_once OPEN_STATION_DIR . 'includes/core/routing.php';

require_once OPEN_STATION_DIR . 'includes/helpers.php';

// Dock + payload assembly. Loaded right after helpers.php so the
// foundational `open_station_is_enabled()` etc. exist by the time
// any payload function is invoked at hook-fire time.
require_once OPEN_STATION_DIR . 'includes/core/payload.php';
require_once OPEN_STATION_DIR . 'includes/assets.php';
require_once OPEN_STATION_DIR . 'includes/admin-bar.php';
require_once OPEN_STATION_DIR . 'includes/session.php';
require_once OPEN_STATION_DIR . 'includes/presence.php';
require_once OPEN_STATION_DIR . 'includes/nonce-refresh.php';
require_once OPEN_STATION_DIR . 'includes/sticky-notes/heartbeat.php';
require_once OPEN_STATION_DIR . 'includes/os-settings.php';
require_once OPEN_STATION_DIR . 'includes/seen-intros.php';
require_once OPEN_STATION_DIR . 'includes/portal.php';
require_once OPEN_STATION_DIR . 'includes/default-window.php';
require_once OPEN_STATION_DIR . 'includes/themes-tabs.php';
require_once OPEN_STATION_DIR . 'includes/media-query.php';
require_once OPEN_STATION_DIR . 'includes/accents.php';
require_once OPEN_STATION_DIR . 'includes/toast-types.php';
require_once OPEN_STATION_DIR . 'includes/registries/native-windows.php';
require_once OPEN_STATION_DIR . 'includes/registries/window-tabs.php';
require_once OPEN_STATION_DIR . 'includes/registries/icons.php';
require_once OPEN_STATION_DIR . 'includes/registries/wallpapers.php';
require_once OPEN_STATION_DIR . 'includes/registries/widgets.php';
require_once OPEN_STATION_DIR . 'includes/components.php';
require_once OPEN_STATION_DIR . 'includes/commands.php';
require_once OPEN_STATION_DIR . 'includes/settings-tabs.php';
require_once OPEN_STATION_DIR . 'includes/dock-rail-renderer.php';
require_once OPEN_STATION_DIR . 'includes/title-bar-buttons.php';
require_once OPEN_STATION_DIR . 'includes/unfocus-effects.php';
require_once OPEN_STATION_DIR . 'includes/window-links.php';
require_once OPEN_STATION_DIR . 'includes/window-chrome.php';
require_once OPEN_STATION_DIR . 'includes/window-notices.php';
require_once OPEN_STATION_DIR . 'includes/wallpapers.php';
require_once OPEN_STATION_DIR . 'includes/mio.php';
require_once OPEN_STATION_DIR . 'includes/widgets/heartbeat.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-comments.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-post-stats.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-site-views.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-jazz-quote.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-starter.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-notes.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-drafts.php';
require_once OPEN_STATION_DIR . 'includes/widgets/widget-focus-timer.php';
require_once OPEN_STATION_DIR . 'includes/extended-options.php';
require_once OPEN_STATION_DIR . 'includes/oauth-relay.php';
require_once OPEN_STATION_DIR . 'includes/ai-copilot/bootstrap.php';
// Content-changes must load before the recycle bin — the bin's
// changelog delegates into the generic recorder.
require_once OPEN_STATION_DIR . 'includes/content-changes.php';
require_once OPEN_STATION_DIR . 'includes/recycle-bin/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/desktop-files/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/desktop-themes/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/notes/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/posts-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/pages-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/users-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/user-edit-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/plugins-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/comments-window/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/my-wordpress/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/content-graph/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/living-tree/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/games/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/agents/bootstrap.php';
require_once OPEN_STATION_DIR . 'includes/pwa.php';
require_once OPEN_STATION_DIR . 'includes/compat/divi.php';
...
// them (see open_station_request_needs_admin_modules()). Relative
// order preserved from the historical unconditional list.
if ( open_station_request_needs_admin_modules() ) {
	require_once OPEN_STATION_DIR . 'includes/ajax.php';
	...
	require_once OPEN_STATION_DIR . 'includes/migrations.php';
	require_once OPEN_STATION_DIR . 'includes/welcome-dialog.php';
	require_once OPEN_STATION_DIR . 'includes/update-notice.php';
	require_once OPEN_STATION_DIR . 'includes/core-notices.php';
	require_once OPEN_STATION_DIR . 'includes/plugin-notices.php';
	require_once OPEN_STATION_DIR . 'includes/render.php';
	require_once OPEN_STATION_DIR . 'includes/devtools.php';
}
 ...
 * `open_station_register_window()`, and the request fatals because the
 ...
 * cascade — e.g. add a plugin that wraps `open_station_*` calls in
 ...
 * `open_station_*` helpers expecting OpenStation to be wired up;
 * firing them mid-cascade can trigger the same fatal we're trying
 * to prevent. Skipping them is the safer default.
 */
function open_station_cascade_deactivate_dependents() {
	...
	add_action( 'shutdown', 'open_station_do_cascade_deactivate', 0 );
}
register_deactivation_hook( OPEN_STATION_FILE, 'open_station_cascade_deactivate_dependents' );
 ...
 * {@see open_station_cascade_deactivate_dependents} for the timing
 * rationale.
 */
function open_station_do_cascade_deactivate() {
	...
	$slug = dirname( plugin_basename( OPEN_STATION_FILE ) );
	if ( '' === $slug || '.' === $slug ) {
		return;
	}
	...
	$dependents = (array) apply_filters(
		'open_station_cascade_deactivate_dependents',
		$dependents,
		$slug
	);
